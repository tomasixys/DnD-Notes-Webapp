...
from app.routers import campaigns, sessions, people, locations, factions, rolls, search
from app.routers.party import stash as party_stash
...
app.include_router(party_stash.router)
