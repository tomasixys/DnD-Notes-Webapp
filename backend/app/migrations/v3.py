"""Migration from schema version 2 to schema version 3.

Version 3 adds private character profiles, character notes and backstory notes,
stores the active character on the campaign, and aligns session notes with the
shared note model.
"""
...
def _migrate_session_content(connection) -> None:
    ...
    if "description" in columns:
        ...
        connection.execute(
            text("ALTER TABLE sessionnote DROP COLUMN description")
        )
