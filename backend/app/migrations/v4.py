"""Migration from schema version 3 to schema version 4.

Version 4 adds campaign inventories, character ownership and management access,
per-inventory purses, denomination balances, and categorized inventory items.
The migration remains schema-aware so databases used during development can be
promoted without losing their existing inventory data.
"""
...
def migrate_to_v4(connection) -> None:
