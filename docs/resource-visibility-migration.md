...
| Character notes and backstory | Campaign-readable; writes are assignment-scoped | Note creator | Add private/member-list visibility and explicit grants before filtering backups. |
...
When resource-specific privacy begins, each schema change must include
